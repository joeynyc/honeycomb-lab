...
APP_NAME=${APP_NAME:-Honeycomb}
BUNDLE_ID=${BUNDLE_ID:-com.joeyrodriguez.honeycomb}
...
MARKETING_VERSION=${MARKETING_VERSION:-${VERSION:-0.1.0}}
...
# App icon lives at Assets/AppIcon.icns (generated in the Grok session).
ICON_TARGET="$ROOT/Assets/AppIcon.icns"
...
APP_ENTITLEMENTS=${APP_ENTITLEMENTS:-$ROOT/Sources/$APP_NAME/Honeycomb.entitlements}
